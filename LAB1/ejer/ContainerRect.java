...
public class ContainerRect {
    ...
    public void addRectangulo(Rectangulo r1){
        ...
        if(numRec<n){
            ...
            arregloRec[numRec] = r1;
            arregloAreas[numRec] = areaRec;
            arregloDistancias[numRec] = distanciaRec;
    ...
    public String toString(){
        ...
        for(int i = 0; i<numRec; i++){
            System.out.println((i+1)+"     "+arregloRec[i].toString()+"    "+arregloDistancias[i]+"   "+arregloAreas[i]);
        }
        return "";
    }
